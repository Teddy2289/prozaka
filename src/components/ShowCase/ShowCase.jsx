...
function ShowCase() {
    return (
        <PaddingContainner id="Home" left="3%" right="10%" top="18%" bottom="10%" responsiveLeft="1rem"
                           responsiveRight="1rem" responsiveTop="8rem">
            <FlexContainer align="start" fullWidthChild>
                ...
                <FlexContainer
                    ...
                    <ShowCaseParticleContainer>
                        <ShowCaseImageCard>
                            <img src={teddy} width={300} alt="teddy"/>
                        </ShowCaseImageCard>
                        <Particle
                            as={motion.img}
                            animate={{
